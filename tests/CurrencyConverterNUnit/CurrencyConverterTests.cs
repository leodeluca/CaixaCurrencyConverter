...
namespace CurrencyConverterMsTest
{
    ...
    public class CurrencyConverterTests
    {
        ...
        public void GivenOneCurrency_WhenConverting_ThenReturnASecondCurrency()
        {
            ...
            // Assert
            Assert.That(result, Is.EqualTo(new Money(amount, Currency.BRL)));
        }
        ...
        public void GivenACurrency_WhenConvertingOnTheContraryWay_ThenReturnTheSameCurrencyValue()
        {
            ...
            // Assert
            Assert.That(Math.Round(result_amount_usd, 3), Is.EqualTo(amount_brl));
            Assert.That(Math.Round(result_amount_brl, 3), Is.EqualTo(amount_usd));
        }
    }
}
